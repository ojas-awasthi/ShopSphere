  ...
  return (
    <div className="container__0">
      ...
      <div className="content-container">
        <p>
          Thank you for shopping with ShopSphere! We want to ensure your
        ...
        <p>
          ...
          process the refund associated with the Cash on Delivery
        ...
        <p>
          ...
          <br />
          <span style={{ fontWeight: "500" }}>Support </span>: Use the Contact Us form
          <br />
      <span style={{ fontWeight: "500" }}>    Hours of Operation: Monday to Friday, 9:00 AM to 5:00 PM </span>
        </p>
        <p>
