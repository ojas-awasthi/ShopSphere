    ...
    <div className="privacy-policy-container">
      ...
      <div className="container___">
        ...
        <p>
          ...
          experience purchasing from our webstore, ShopSphere.com.
        </p>
        <p>
        ...
        <p>
          You (“Customer”) may place orders for Products with ShopSphere
          ...
          agreed to or set forth in writing by ShopSphere, any term or
        ...
        <h2>Orders</h2>
        <p>
          All orders are subject to ShopSphere's acceptance. This means
          ShopSphere may, for any reason, refuse to accept or may cancel or
          ...
          cancel an order after you have already been charged, ShopSphere
        ...
        <p>
          ...
          and it is accepted by ShopSphere. Prices for products displayed on
          ...
          website may differ from those in stores that stock ShopSphere
          products, as these stores are independent of ShopSphere.
          ShopSphere reserves the right to amend pricing for any pricing
          ...
          submitted an online order, ShopSphere will notify you of the error
        ...
        <p>
          ...
          ShopSphere reserves the right to change or discontinue such offers
          at any time.
        </p>
        <h2>Taxes</h2>
        <p>
          The prices quoted for the products sold hereunder include applicable
          taxes. Customer shall pay, and reimburse ShopSphere if it pays, any
          taxes, except for those based on ShopSphere's income.
        </p>
        <h2>Payment</h2>
        <p>
        ...
        <p>
          ...
          process. Any timeframe provided by ShopSphere for when the
          ...
          are beyond our control. ShopSphere cannot be held liable for late
        ...
        <h2>Returns</h2>
        <p>
          Once an order has been placed and accepted by ShopSphere, customer
          may not cancel such accepted order without ShopSphere’s prior
          ...
          expenses. The product(s) must be returned to ShopSphere within
        ...
        <p>
          ...
          indemnify and hold ShopSphere harmless from and against any and all
        ...
        <p style={{ fontWeight: "500" }}>ShopSphere</p>
        <p style={{ fontWeight: "500" }}>123 Main Street, City, Country</p>
        <p style={{ fontWeight: "500" }}>
          Email:{" "}
          <span style={{ fontWeight: "400" }}>Use the Contact Us form</span>
        </p>
      </div>
    </div>
  );
