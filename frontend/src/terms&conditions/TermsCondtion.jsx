  ...
  return (
    <div className="terms-container">
      ...
      <div className="terms-content">
        <p>
          Thank you for shopping with ShopSphere! We appreciate your business
          and your interest in our products. We want to make sure you
        ...
        <p>
          ...
          agreed to in writing by ShopSphere.
        </p>
        <h2>Orders</h2>
        <p>
          All orders are subject to ShopSphere's acceptance. We may refuse to
        ...
        <p>
          ...
          ShopSphere. Prices displayed on the website exclude shipping
          ...
          from those in physical stores that stock ShopSphere products. We
        ...
        <p>
          ...
          taxes, except for those based on ShopSphere's income. If
          ShopSphere is required to collect and pay taxes on Customer's
        ...
        <p>
          ...
          order without ShopSphere's written consent. You may return products
        ...
        <p>
          You agree to indemnify and hold ShopSphere harmless from any
          claims, costs, proceedings, losses, or demands arising from your
          breach of these Terms or anyone using your account.
        </p>
        <h2>Entire Agreement</h2>
        <p>
          These Terms constitute the entire agreement between ShopSphere and
