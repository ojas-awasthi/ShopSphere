...
const slides = [
  {
    image: require("../../image/sports-banners/img2.png"),
    quote:
      "Gear Up for Every Game and Embrace the Thrill of Competition",
    saleText:
      "Discover great deals across a wide range of premium sports gear",
    productText: "Shop Now",
  },
  {
    image: require("../../image/sports-banners/03.jpg"),
    quote:
      "Experience the thrill of competition with premium sports equipment",
    saleText:
      "Limited Time Offer: Don't miss out on the opportunity to upgrade your game",
    productText: "Buy Now",
  },
  {
    image: require("../../image/sports-banners/01.jpg"),
    quote:
      "Gear up with the latest products and perform at your best",
    saleText: "Discover New Arrivals and stay ahead of the competition",
    productText: "Explore",
  },
  {
    image: require("../../image/sports-banners/04.jpg"),
    quote:
      "Elevate your performance with carefully selected sports gear",
