...
import ShopSphereLoader from "../layouts/louder/Loader";
          ...
          <form className={classes.form}>
            ...
            >
              <Grid item>
                <FormControlLabel
                  control={<Checkbox />}
                  label="I Accept The ShopSphere Terms & Conditions"
              ...
              <Grid item>
                <FormControlLabel
                  control={<Checkbox />}
                  label="I Accept The ShopSphere Terms Of Use"
                  className={classes.checkbox}
            ...
            >
              I acknowledge ShopSphere will use my information in accordance
              with its
